...
from scripts_hgt.varint import writableString
...
class Output(object):
	...
	"""
	def __init__(self, fName, boundsTag, gzip=0):
		...
		self.elevClassifier = makeElevClassifier(200,100)
		self.phyghtmapVersion= "1.0"
